module.exports = {
  siteMetadata: {
    ...
    image: `https://github.com/mattrbanks/professional-portfolio/blob/master/src/images/portfolio-social-sharing-image-newer.jpg?raw=true`,
  },
  plugins: [
    ...
    `gatsby-plugin-sharp`,
    {
      ...
      options: {
        ...
        theme_color: `#663399`,
        display: `minimal-ui`,
        icon: `src/images/mblogo.svg`, // This path is relative to the root of the site.
      },
    },
  ],
}
